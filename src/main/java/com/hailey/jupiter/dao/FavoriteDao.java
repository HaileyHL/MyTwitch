package com.hailey.jupiter.dao;

//orm data access object. Manipulates data.
...
public class FavoriteDao {
    ...
    private SessionFactory sessionFactory; //connects to db. Click to navigate

    // Insert a favorite record to the database
    // Matches "Add favorite item" in postman
    ...
    // Matches "Delete favorite item" in postman
